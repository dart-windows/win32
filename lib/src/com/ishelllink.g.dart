...
base class IShellLinkVtbl extends Struct {
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszFile,
  ...
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszDir)>>
      SetWorkingDirectory;
  external Pointer<
          NativeFunction<
              Int32 Function(
  ...
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszArgs)>>
      SetArguments;
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<Uint16> pwHotkey)>>
      GetHotkey;
  external Pointer<
          NativeFunction<Int32 Function(VTablePointer lpVtbl, Uint16 wHotkey)>>
      SetHotkey;
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<Int32> piShowCmd)>>
      GetShowCmd;
  external Pointer<
          NativeFunction<Int32 Function(VTablePointer lpVtbl, Int32 iShowCmd)>>
      SetShowCmd;
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszIconPath,
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszPathRel,
              Uint32 dwReserved)>> SetRelativePath;
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, IntPtr hwnd, Uint32 fFlags)>>
      Resolve;
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<Utf16> pszFile)>>
