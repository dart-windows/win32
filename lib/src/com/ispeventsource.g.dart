...
/// mechanism by which it receives notifications.
///
/// Applications can configure which events should trigger notifications and
/// which events retrieve queued events. ISpEventSource inherits from the
