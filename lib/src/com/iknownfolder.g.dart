...
/// (PIDL) value, redirection capabilities, and definition. It provides a method
/// for the retrieval of a known folder's `IShellItem` object. It also provides
...
base class IKnownFolderVtbl extends Struct {
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Pointer<GUID> pkfid)>> GetId;
  external Pointer<
          NativeFunction<
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Uint32 dwFlags,
  ...
  external Pointer<
          NativeFunction<
              Int32 Function(VTablePointer lpVtbl, Pointer<GUID> pftid)>>
      GetFolderType;
  external Pointer<
          NativeFunction<
              Int32 Function(
