...
/// stream belongs to. This is the session that the client assigned the stream
/// to during the call to the `IAudioClient::Initialize` method. The client
/// obtains a reference to the [IChannelAudioVolume] interface on a stream
/// object by calling the `IAudioClient::GetService` method with parameter
/// `riid` set to REFIID [IID_IChannelAudioVolume].
///
/// {@category com}
...
base class IChannelAudioVolumeVtbl extends Struct {
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, Uint32 dwIndex, Float fLevel,
