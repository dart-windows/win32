...
/// the item. [IShellItem] and [IShellItem2] are the preferred representations
...
base class IShellItem2Vtbl extends Struct {
  ...
  external Pointer<
      NativeFunction<
          Int32 Function(VTablePointer lpVtbl, VTablePointer pbc)>> Update;
  external Pointer<
      NativeFunction<
