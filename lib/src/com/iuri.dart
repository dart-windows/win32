...
class IUri extends IUnknown {
  ...
  int hasProperty(int uriProp, Pointer<Int32> pfHasProperty) =>
      _vtable.HasProperty.asFunction<
          int Function(VTablePointer, int uriProp,
  ...
  int getHost(Pointer<Pointer<Utf16>> pbstrHost) => _vtable.GetHost.asFunction<
      int Function(
          VTablePointer, Pointer<Pointer<Utf16>> pbstrHost)>()(ptr, pbstrHost);
  ...
  int getPath(Pointer<Pointer<Utf16>> pbstrPath) => _vtable.GetPath.asFunction<
      int Function(
          VTablePointer, Pointer<Pointer<Utf16>> pbstrPath)>()(ptr, pbstrPath);
  ...
  int getHostType(Pointer<Uint32> pdwHostType) =>
      _vtable.GetHostType.asFunction<
          int Function(
              VTablePointer, Pointer<Uint32> pdwHostType)>()(ptr, pdwHostType);

  int getPort(Pointer<Uint32> pdwPort) => _vtable.GetPort.asFunction<
      int Function(VTablePointer, Pointer<Uint32> pdwPort)>()(ptr, pdwPort);

  int getScheme(Pointer<Uint32> pdwScheme) => _vtable.GetScheme.asFunction<
      int Function(VTablePointer, Pointer<Uint32> pdwScheme)>()(ptr, pdwScheme);

  int getZone(Pointer<Uint32> pdwZone) => _vtable.GetZone.asFunction<
      int Function(VTablePointer, Pointer<Uint32> pdwZone)>()(ptr, pdwZone);

  int getProperties(Pointer<Uint32> pdwFlags) => _vtable.GetProperties
          .asFunction<int Function(VTablePointer, Pointer<Uint32> pdwFlags)>()(
      ptr, pdwFlags);

  int isEqual(VTablePointer pUri, Pointer<Int32> pfEqual) =>
      _vtable.IsEqual.asFunction<
          int Function(VTablePointer, VTablePointer pUri,
...
base class IUriVtbl extends Struct {
  ...
  external Pointer<
          NativeFunction<
              Int32 Function(
                  VTablePointer, VTablePointer pUri, Pointer<Int32> pfEqual)>>
      IsEqual;
}
