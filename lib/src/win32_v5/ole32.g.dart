...
/// ```
/// {@category ole32}
int CLSIDFromProgID(PWSTR lpszProgID, Pointer<GUID> lpclsid) =>
...
final _CLSIDFromProgID = _ole32.lookupFunction<
    ...
    int Function(PWSTR lpszProgID, Pointer<GUID> lpclsid)>('CLSIDFromProgID');
...
/// ```
/// {@category ole32}
int CLSIDFromProgIDEx(PWSTR lpszProgID, Pointer<GUID> lpclsid) =>
    _CLSIDFromProgIDEx(lpszProgID, lpclsid);

final _CLSIDFromProgIDEx = _ole32.lookupFunction<
    HRESULT Function(PWSTR lpszProgID, Pointer<GUID> lpclsid),
    int Function(PWSTR lpszProgID, Pointer<GUID> lpclsid)>('CLSIDFromProgIDEx');
...
/// ```
/// {@category ole32}
int CLSIDFromString(PWSTR lpsz, Pointer<GUID> pclsid) =>
...
/// ```
/// {@category ole32}
int GetClassFile(PWSTR szFilename, Pointer<GUID> pclsid) =>
...
/// ```
/// {@category ole32}
int IIDFromString(PWSTR lpsz, Pointer<GUID> lpiid) =>
...
/// ```
/// {@category ole32}
int ProgIDFromCLSID(Pointer<GUID> clsid, Pointer<PWSTR> lplpszProgID) =>
...
final _ProgIDFromCLSID = _ole32.lookupFunction<
    ...
    int Function(
        Pointer<GUID> clsid, Pointer<PWSTR> lplpszProgID)>('ProgIDFromCLSID');
...
/// ```
/// {@category ole32}
int StringFromCLSID(Pointer<GUID> rclsid, Pointer<PWSTR> lplpsz) =>
...
/// ```
/// {@category ole32}
int StringFromIID(Pointer<GUID> rclsid, Pointer<PWSTR> lplpsz) =>
    _StringFromIID(rclsid, lplpsz);

final _StringFromIID = _ole32.lookupFunction<
    HRESULT Function(Pointer<GUID> rclsid, Pointer<PWSTR> lplpsz),
    int Function(Pointer<GUID> rclsid, Pointer<PWSTR> lplpsz)>('StringFromIID');
