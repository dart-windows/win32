...
int CreateStreamOnHGlobal(
        Pointer hGlobal, int fDeleteOnRelease, Pointer<VTablePointer> ppstm) =>
    _CreateStreamOnHGlobal(hGlobal, fDeleteOnRelease, ppstm);

final _CreateStreamOnHGlobal = _ole32.lookupFunction<
    Int32 Function(
        Pointer hGlobal, Int32 fDeleteOnRelease, Pointer<VTablePointer> ppstm),
...
/// ```
/// {@category ole32}
int GetHGlobalFromStream(VTablePointer pstm, Pointer<Pointer> phglobal) =>
...
final _GetHGlobalFromStream = _ole32.lookupFunction<
    ...
    int Function(
        VTablePointer pstm, Pointer<Pointer> phglobal)>('GetHGlobalFromStream');
